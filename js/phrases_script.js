...
document.getElementById('form-edit').addEventListener("submit", function(e){
	...
	if(imageEdit == '' || imageEdit == null){
        urlAjax = "./php/phrases_controller.php?type=edit&id=" + idEdit;
    }else{
    	urlAjax = "./php/phrases_controller.php?type=editWithImage&id=" + idEdit;   
    } 
...
function deleteData(){
    ...
    ajax.open('POST', './php/phrases_controller.php?type=delete&id=' + idDelete + '&image=' + imageDelete, true);
    ajax.send();
